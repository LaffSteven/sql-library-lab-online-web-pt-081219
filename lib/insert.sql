...
INSERT INTO characters (id, name, motto, species, author_id) VALUES (1, "Frodo Baggins", "We set out to save the Shire, Sam.", "Hobbit", 1), (2, "Samwise Gamgee", "Hold on Mr. Frodo.", "Hobbit", 1), (3, "Aragorn II Elessar", "There is still hope.", "Dúnedain", 1), (4, "Gandalf", "Fly, you fools.", "human", 1);
